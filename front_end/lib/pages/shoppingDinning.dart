...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: const ShoppindAndDinning(),
    );
  }
}

class ShoppindAndDinning extends StatefulWidget {
  const ShoppindAndDinning({super.key});

  @override
  State<ShoppindAndDinning> createState() => _ShoppindAndDinningState();
}

class _ShoppindAndDinningState extends State<ShoppindAndDinning> {
