...
class ShoppingDiningScreen extends StatelessWidget {
  const ShoppingDiningScreen({Key? key}) : super(key: key);
          ...
          Column(
            children: [
              ...
              Row(
                mainAxisAlignment: MainAxisAlignment.spaceEvenly,
                children: [
                  _buildImageCardWithButton('assets/bgimage.png', 'Dining and Shopping'),
